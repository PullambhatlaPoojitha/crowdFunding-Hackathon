...
const Hero = () => {
  ...
  return (
    <div className="text-center bg-white text-gray-800 py-24 px-6">
      ...
      >
        <span>Bring life to a </span>
        <span className="uppercase text-green-600">Cause</span>
        <br />
        {/* <span className="uppercase text-green-600">SPUNK FUNDER</span> */}
      </h1>
      ...
      <div className="flex justify-center items-center mt-10">
        ...
        >
          <span
            ...
            leading-5"
          >
            {(stats?.totalDonations)-1.42 || 0} ETH
          </span>
          <span>Donated</span>
        </div>
      </div>
